...
{
	[TestFixture]
	public class Fixture_04_MultipleNestedActivities
	{
		[TestFixtureSetUp]
		public void SetUp ()
		{
		...
		public void Test_ReportItem ()
		{
			...
			Assert.AreEqual(_ReportItem.Duration.Value.TotalSeconds, 7d);
		...
		public void Test_ChildReportItems ()
		{
			...
			Assert.AreEqual(_ReportItem.ChildReportItems.Length, 3);
		}
