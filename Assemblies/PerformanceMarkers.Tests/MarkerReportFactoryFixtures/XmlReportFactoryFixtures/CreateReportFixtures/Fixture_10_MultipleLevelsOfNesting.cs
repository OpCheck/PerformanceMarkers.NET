...
namespace PerformanceMarkers.Tests.MarkerReportFactoryFixtures.XmlReportFactoryFixtures.CreateReportFixtures
{
	[TestFixture]
	public class Fixture_10_MultipleLevelsOfNesting
	{
		...
		public void SetUp ()
		{
			...
			// CREATE THE REPORT.
			//
			_ReportText = MarkerReportFactoryProvider.CreateReportFactory(MarkerReportFactoryType.Xml).CreateReport(CreatedMarker);
		}
